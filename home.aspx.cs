...
public partial class _Home : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (NewsInfo news in latestList)
        {
            ...
            {
                latestNews.Append(string.Format("<li style='word-wrap:break-word;'><a href='{1}' style='position: relative;'><span class='blueFont'>{2:" 
                    + GlobalSetting.DateTimeFormat + "}</span>&nbsp&nbsp&nbsp{0}&nbsp&nbsp&nbsp </a></li>", news.Title,
        ...
        {
            latestTraining.Append(string.Format("<li style='word-wrap:break-word;'><a href='{1}'><span class='blueFont'>{2:" + GlobalSetting.DateTimeFormat + "}</span>&nbsp&nbsp&nbsp{0}</a></li>", training.Name,
